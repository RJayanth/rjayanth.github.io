export const ABOUT_ME = {
  HEADING: `Hey there! I'm a passionate frontend developer with a flair for transforming ideas into interactive digital experiences. My journey into the world of web development began 8 years ago, driven by a curiosity to understand the magic behind the web pages we interact with daily.`,
  EXPERIENCE:
    'With a strong foundation in HTML, CSS, and JavaScript, I specialize in crafting seamless and responsive web applications that not only look great but also provide an intuitive user experience.',
...
export const WORK_EXPERIENCE = {
  ...
  CERNER: {
    OVERVIEW: "Responsible for developing user interface components, with experience in the healthcare domain.",
    RESPONSIBILITIES: [
      "Developing user interface components",
      "Fixing bugs",
      "Participating in peer code reviews",
